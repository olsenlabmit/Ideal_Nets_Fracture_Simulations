####### Plot scattering patterns and pair correlation functions ##########
import shutil
...
nets_arr=['bod','boe','nbo-a','sgn','srs','srs-a','srs-b','srs-c3','srs-c4','sxt','utb']
...
if(test==True):
  fig.savefig('scattering_pattern_pair_corr_fn_publication.png', dpi=300, bbox_inches='tight')
